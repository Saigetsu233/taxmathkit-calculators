...
export const tools: TaxTool[] = [
  {
    ...
    title: "2025–2026 Federal Income Tax Calculator by Filing Status",
    eyebrow: "US federal estimate",
    description: "Calculate federal income tax by filing status, gross income and deductions, then see taxable income, effective rate and marginal bracket.",
  ...
  },
  {
    ...
    title: "Sales Tax Calculator by State & Local Rate",
    eyebrow: "Add tax to a price",
    description: "Calculate sales tax, pre-tax price and final total with a verified state or local combined rate you enter.",
    metaDescription: "Free sales tax calculator by state and local rate. Enter a price and verified combined rate to calculate tax and total instantly.",
  ...
  },
  {
    ...
    title: "2026 Self-Employment Tax Calculator — 92.35% Base",
    eyebrow: "Social Security + Medicare",
    description: "Calculate 2026 self-employment tax from net profit using the 92.35% base, Social Security limit and Medicare tax.",
  ...
  },
  {
    slug: "1099-tax-calculator",
      title: "2026 1099 Tax Calculator — Per-Payment Reserve & Quarterly Tax",
    eyebrow: "Freelancer total-tax estimate",
      description: "Plan a 1099 tax reserve from business profit, W-2 withholding and a typical payment—then compare the annual and quarterly federal estimate.",
      metaDescription: "Free 2026 1099 tax reserve calculator: estimate federal and self-employment tax, quarterly payments, and how much to set aside from each freelance payment.",
    category: "Freelance", badge: "High opportunity", taxYear: "2026", updated: "August 5, 2026",
      primaryKeyword: "1099 tax calculator", keywords: ["how much to set aside for 1099 taxes", "1099 tax reserve calculator", "freelance tax calculator", "tax reserve per payment", "1099 quarterly payment calculator"],
      formulaTitle: "1099 profit to an actionable cash reserve",
      formula: "Net business profit = 1099 revenue − business expenses. Estimate SE tax, deduct its employer-equivalent half, apply 2026 federal brackets, then divide remaining tax by 1099 revenue to estimate a reserve rate for each payment.",
      explanation: ["This combines a detailed SE-tax estimate with a simplified federal ordinary-income estimate and turns the remaining amount into a per-payment reserve suggestion.", "State income tax, most credits, itemized deductions, retirement contributions and exact QBI limitations are outside the default calculation."],
