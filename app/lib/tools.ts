...
export const tools: TaxTool[] = [
  ...
  },
  {
    ...
    title: "2026 1099 Tax Calculator — Federal, SE & Quarterly Reserve",
    eyebrow: "Freelancer total-tax estimate",
    description: "Calculate federal income tax, self-employment tax, quarterly reserve and take-home income from 1099 revenue and business deductions.",
