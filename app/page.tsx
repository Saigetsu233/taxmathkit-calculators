      ...
      <section className="hero">
        <div className="shell hero-grid">
          <div className="hero-copy">
            ...
            <div className="hero-actions"><Link className="button primary" href="/tools/income-tax-calculator">Calculate federal tax</Link><Link className="button secondary" href="/freelancer-tax-planner">Plan 1099 cash flow</Link><Link className="button secondary" href="#calculators">Browse all 12 tools</Link></div>
